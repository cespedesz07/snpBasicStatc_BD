...
public class ProcesamientoPED extends Thread{
    ...
    private static final String TIPO_FRECUENCIAS_ALELICAS = "";
    ...
    public synchronized void conteoFrecuenciasGenotipicas( int numhilo, int opcion,
            SNP snpRef, int[][] opcionesTotalesFrecGen, double[][] opcionesFrecuenciasFrecGen ) throws Exception{
        ...
        */
        ...
        try{
            int idCalculo = (numhilo * 10) + opcion;
            //this.conexion.insertarCalculo( idCalculo, "FrecuenciasGenotipicas"+opcionCalculoFrecuencias, numhilo );
            this.conexion.insertarFrecuenciasGenotipicas( idCalculo, Arrays.toString(totales), Arrays.toString(genotipos), 
                    Arrays.toString(frecuencias), numhilo, "FrecuenciasGenotipicas"+opcionCalculoFrecuencias );
        }
    ...
    public synchronized void conteoFrecuenciasAlelicas( int numhilo, int opcion,
          SNP snpRef, int[][] opcionesTotales, double[][] opcionesFrecuencias ) throws Exception{      
        ...
        */
        ...
        try{
            int idCalculo = (numhilo * 10) + opcion;
            //this.conexion.insertarCalculo( idCalculo, "FrecuenciasAlelicas"+opcionCalculoFrecuencias, numhilo );
            this.conexion.insertarFrecuenciasAlelicas( idCalculo, Arrays.toString(arregloTotales), Arrays.toString(arregloAlelos), 
                    Arrays.toString(arregloFrecuencias), numhilo, "FrecuenciasAlelicas"+opcionCalculoFrecuencias );
        }
        catch ( Exception error ){
            throw new Exception( error.getMessage() );
        }
    ...
    public synchronized void equilibrioHW( int numhilo, int opcion,
          SNP snpRef, Object[][][] opcionesEquilibrioHW ) throws Exception{
        ...
        try{
            int idCalculo = (numhilo * 10) + opcion;
            //this.conexion.insertarCalculo( idCalculo, "EquilibrioHW" + opcionCalculoFrecuencias, numhilo );
            this.conexion.insertarEquilibrioHW( idCalculo, Arrays.toString(arregloGenotipos), Arrays.toString(arregloObservados), 
                    Arrays.toString(arregloEsperados), Arrays.toString(arregloChi2), numhilo, "EquilibrioHW" + opcionCalculoFrecuencias );            
        }
        catch ( Exception error ){
            throw new Exception( error.getMessage() );
        }
    ...
    {          
        for( int i=inicioP; i<finalP; i++ ){
            ...
            */           
            ...
            this.conexion.insertarSNP( i, "SNP"+i );
            ...
            */
            try{
                conteoFrecuenciasAlelicas( i, FRECUENCIAS_ALELICAS_TODOS, snpRef, opcionesTotalesFrecAlelicas, opcionesFrecuenciasFrecAlelicas );
                conteoFrecuenciasAlelicas( i, FRECUENCIAS_ALELICAS_CASOS, snpRef, opcionesTotalesFrecAlelicas, opcionesFrecuenciasFrecAlelicas );
                conteoFrecuenciasAlelicas( i, FRECUENCIAS_ALELICAS_CONTROLES, snpRef, opcionesTotalesFrecAlelicas, opcionesFrecuenciasFrecAlelicas );
                opcionesTotalesFrecAlelicas = null;
                opcionesFrecuenciasFrecAlelicas = null;


                conteoFrecuenciasGenotipicas(i, FRECUENCIAS_GENOTIPICAS_TODOS, snpRef, opcionesTotalesFrecGen, opcionesFrecuenciasFrecGen);
                conteoFrecuenciasGenotipicas(i, FRECUENCIAS_GENOTIPICAS_CASOS, snpRef, opcionesTotalesFrecGen, opcionesFrecuenciasFrecGen);
                conteoFrecuenciasGenotipicas(i, FRECUENCIAS_GENOTIPICAS_CONTROLES, snpRef, opcionesTotalesFrecGen, opcionesFrecuenciasFrecGen);            
                opcionesTotalesFrecGen = null;
                opcionesFrecuenciasFrecGen = null;


                equilibrioHW(i, EQUILIBRIO_HW_TODOS, snpRef, opcionesEquilibrioHW);
                equilibrioHW(i, EQUILIBRIO_HW_CASOS, snpRef, opcionesEquilibrioHW);
                equilibrioHW(i, EQUILIBRIO_HW_CONTROLES, snpRef, opcionesEquilibrioHW);
