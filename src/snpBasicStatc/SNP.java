...
public class SNP {
    ...
    {
        double resultado = Math.pow( (heterocigoto.totalControles()-esperadosControlesHetero()),2)/esperadosControlesHetero();
        return Math.round( resultado * 100.0 ) / 100.0;
    }
    
    public double chiCuadradoMenorFrecuenciaControles()
    {
        double resultado = Math.pow((homocigotoMenorFr.totalControles()-esperadosControlesAleloMenorFr()),2)/esperadosControlesAleloMenorFr();
        return Math.round( resultado * 100.0 ) / 100.0;
    }
    ...
    {
        double resultado = chiCuadradoMayorFrecuenciaTodos()+chiCuadradoHeterocigotoTodos()+chiCuadradoMenorFrecuenciaTodos();
        return Math.round( resultado * 100.0 ) / 100.0;
    }
    
    public double sumachiCuadradoCasosSignificancia()
    {
        double resultado = chiCuadradoMayorFrecuenciaCasos()+chiCuadradoHeterocigotoCasos()+chiCuadradoMenorFrecuenciaCasos();
        return Math.round( resultado * 100.0 ) / 100.0;
    }
    
    public double sumachiCuadradoControlesSignificancia()
    {
        double resultado = chiCuadradoMayorFrecuenciaControles()+chiCuadradoHeterocigotoControles()+chiCuadradoMenorFrecuenciaControles();
        return Math.round( resultado * 100.0 ) / 100.0;
    }
